...
#define PE_MEMORY_RENDER_SURFACE   1024*1024*8 
#define PE_MEMORY_CACHE_NODE       128 
#define PE_MEMORY_RUNTIME_SIZE (1024*1024*64+PE_MEMORY_RENDER_SURFACE+PE_MEMORY_CACHE_NODE)
#define PE_MEMORY_UI_SIZE 1024*1024*16 
#define PE_MEMORY_RESOURCES_SIZE 1024*1024*16
#define PE_MEMORY_GAME_SIZE 1024*1024*8 
